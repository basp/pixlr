...
public class Matrix4x4Tests
{
    ...
    public void TestMatrixEqualityWithIdenticalMatrices()
    {
        ...
        var comparer = new Matrix4x4EqualityComparer(epsilon);
    ...
    public void TestTransposeMatrix()
    {
        ...
        var comparer = new Matrix4x4EqualityComparer(epsilon);
        Assert.Equal(expected, Matrix4x4.Transpose(m), comparer);
    }
    ...
    public void TestSubmatrix()
    {
        ...
        var comparer = new Matrix3x3EqualityComparer(epsilon);
    ...
    public void TestCalculatingTheInverseOfAMatrix()
    {
        ...
        Assert.True(Matrix4x4.Invert(a, out var b));
        var expected = new Matrix4x4(
        ...
        Assert.Equal(532, a.GetDeterminant());
    ...
    public void TestMultiplyingAMatrixByItsInverse()
    {
        ...
        var comparer = new Matrix4x4EqualityComparer(0.00001);
        Assert.True(Matrix4x4.Invert(b, out var binv));
        Assert.Equal(a, c * binv, comparer);
    }
}